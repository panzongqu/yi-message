var IMAGESPATH = window.Electron.ipcRenderer.sendSync('global-getAppPath') + '/web_contents/js/plugins/zDialog/rightbox/'; //图片路径配置
...
Dialog.prototype.closeByHand = function () {
	...
	if(this.dataChange){//第一版暂时取消该提示
		top.Dialog.confirm("数据发生更改且尚未保存，确定离开吗？",function(){
